          ...
          <div class="home page">
            ...
            <div id="home-content" >
              ...
              <div class="row mt-md-5 pt-5 mb-5 pb-lg-5">
                <div class="cover-photo" :style="{'background-image': 'url(' + require('@/assets/case-studies/studio-eleven/hero.jpg') + ')'}">
                  &nbsp;
                </div>
              </div>
                ...
                <router-link class="no-dec" to="/callie-tomblin">
                  <div class="row mt-5 pt-5 breakout justify-content-center">
                    <div class="col mt-5" style="background-color: #252525;" >
                      <h4 class="no-dec my-auto " style="color: rgb(165, 165, 165); padding-top: 15%; padding-bottom: 15%;">Next Project: <br><span style="color: white;">Callie Tomblin</span></h4>
                    </div>
                  </div>
                </router-link>
